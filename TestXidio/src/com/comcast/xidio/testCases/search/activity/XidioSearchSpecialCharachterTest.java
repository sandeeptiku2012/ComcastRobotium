...
public class XidioSearchSpecialCharachterTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioSearchSpecialCharachterTest() {
	...
	public void testXidioSearchSpecialCharachter() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		solo.sleep(TestConstants.SLEEP_TIME_2000);
		solo.sendKey(KeyEvent.KEYCODE_SLASH);
		solo.sendKey(KeyEvent.KEYCODE_POUND);
		solo.sendKey(KeyEvent.KEYCODE_AT);
		solo.sendKey(KeyEvent.KEYCODE_STAR);
