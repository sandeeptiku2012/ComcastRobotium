...
public class XidioSearchPopularVideoTitleTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchPopularVideoTitleTest() {
	...
	public void testXidioSearchPopularVidoTitle() 
	{
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularVideoTitle " , e);
			} 
		}
