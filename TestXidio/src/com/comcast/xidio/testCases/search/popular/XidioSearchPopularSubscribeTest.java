...
public class XidioSearchPopularSubscribeTest extends ActivityInstrumentationTestCase2<FirstRun> 
{
	private Solo solo;


	public XidioSearchPopularSubscribeTest() {
	...
	public void testXidioSearchPopularSubscribe() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : filteredPopularArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularSubscribe :" , e);
			}
		}
