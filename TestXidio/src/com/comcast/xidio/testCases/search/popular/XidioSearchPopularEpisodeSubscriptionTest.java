...
public class XidioSearchPopularEpisodeSubscriptionTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchPopularEpisodeSubscriptionTest() {
	...
	public void testXidioSearchPopularEpisodeSubscription() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularEpisodeSubscription " , e);
			}
		}
