...
public class XidioSearchPopularShowsTitleTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchPopularShowsTitleTest() {
	...
	public void testXidioSearchPopularShowsTitle() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularShowsTitle " , e);
			}
		}
