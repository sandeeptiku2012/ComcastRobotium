...
public class XidioSearchChannelHighlightedContentTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchChannelHighlightedContentTest() {
	...
	public void testXidioSearchhannelHighlightedContent() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchChannelHighlightedContent " , e);
			}
		}
