...
public class XidioSearchChannelShowSubscriptionTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchChannelShowSubscriptionTest() {
	...
	public void testXidioSearchChannelShowSubscription() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchChannelShowSubscription " , e);
			}
		}
