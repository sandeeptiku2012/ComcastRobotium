...
public class XidioSearchChannelEpisodeSubcriptionTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchChannelEpisodeSubcriptionTest() {
	...
	public void testXidioSearchChannelEpisodeSubscription() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchChannelEpisodeSubcription " , e);
			}
		}
