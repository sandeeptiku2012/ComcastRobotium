...
public class XidioSearchChannelResult extends ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;


	public XidioSearchChannelResult() {
	...
	public void testXidioSearchChannelResult() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchChannelResult " , e);
			}
		}
