package com.comcast.xidio.testCases.search.featured;
...
public class XidioSearchFeaturedResultTest extends ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;
	private ArrayList<JSONObject> filteredItems;


	public XidioSearchFeaturedResultTest() {
	...
	public void testXidioSearchFeaturedResult() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : filteredItems) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchFeaturedResult " , e);
				}
		}
