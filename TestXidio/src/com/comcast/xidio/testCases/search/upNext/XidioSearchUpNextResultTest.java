package com.comcast.xidio.testCases.search.upNext;
...
public class XidioSearchUpNextResultTest
extends ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioSearchUpNextResultTest() {
	...
	public void testXidioSearchUpNextResult()
	{
		...
		if(filteredUpNexArray!= null && filteredUpNexArray.size()>0)
		{
			for (JSONObject currentObject : filteredUpNexArray) {
				try {
					...
					Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchUpNextResult " , e);
				}
			}
		}
