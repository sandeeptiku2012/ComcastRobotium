...
public class XidioSubscriptionEpisodesNetworkImageTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	private JSONObject currChannel;
	
	public XidioSubscriptionEpisodesNetworkImageTest() {
	...
	public void testXidioSubscriptionEpisodesNetworkImage() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			try {
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionEpisodesNetworkImage test", e);
			}
			solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
			solo.sleep(TestConstants.SLEEP_TIME_2000);
		}
