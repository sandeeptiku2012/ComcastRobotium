...
public class XidioSubscriptionButtonLabelChangeTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;	
	
	public XidioSubscriptionButtonLabelChangeTest() {
	...
	public void testXidioSubscriptionButtonLabelChange() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e("Exception:", "Exception occured in XidioSubscriptionButtonLabelChange test cases.", e);
		}
