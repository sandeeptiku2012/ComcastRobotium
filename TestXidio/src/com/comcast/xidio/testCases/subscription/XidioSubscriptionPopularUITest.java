...
public class XidioSubscriptionPopularUITest  extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	
	public XidioSubscriptionPopularUITest() 
	{
	...
	public void testXidioSubscriptionPopularUITest() 
	{
		...
		try 
		{
			...
			Log.e("Exception:", "Exception occured in XidioSubscriptionPopularUITest test case.", e);
		}
		...
		try {
			...
			{
				Log.e("Exception occured in XidioSubscriptionPopularUITest test case", e.getLocalizedMessage());
			}
