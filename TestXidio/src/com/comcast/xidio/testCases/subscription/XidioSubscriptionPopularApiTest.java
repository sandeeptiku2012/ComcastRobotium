...
public class XidioSubscriptionPopularApiTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioSubscriptionPopularApiTest() 
	{
	...
	public void testXidioSubscriptionPopularApiTest() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e("Exception:", "Exception occured in XidioSubscriptionPopularApiTest test case.", e);
		}
		...
		{
				Log.e("Exception occured in XidioSubscriptionPopularApiTest", e.getLocalizedMessage());
		}
		...
		catch (JSONException e)
		{
			...
			Log.e("Exception occured in XidioSubscriptionPopularApiTest in get Title of the channel", e.getLocalizedMessage());
		}
