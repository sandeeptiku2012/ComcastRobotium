...
public class XidioSubscriptionShowActivity extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	...
	public XidioSubscriptionShowActivity() {
	...
	public void testXidioSubscriptionShowActivity() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			...
			try {
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionShowActivity test", e);
			}
		}
		solo.sendKey(KeyEvent.KEYCODE_BACK);
		solo.sleep(TestConstants.SLEEP_TIME_2000);
