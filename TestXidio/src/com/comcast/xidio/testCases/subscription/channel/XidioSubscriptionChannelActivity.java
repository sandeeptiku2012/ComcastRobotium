...
public class XidioSubscriptionChannelActivity extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	...
	public XidioSubscriptionChannelActivity() {
	...
	public void testXidioSubscriptionChannelActivity() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			try {
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionChannelActivity test", e);
			}
		}
		solo.sendKey(KeyEvent.KEYCODE_BACK);
		solo.sleep(TestConstants.SLEEP_TIME_2000);
