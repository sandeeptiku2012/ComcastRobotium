...
public class XidioSubscriptionEpisodeSubcriptionTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	private JSONObject currChannel;
	
	public XidioSubscriptionEpisodeSubcriptionTest() {
	...
	public void testXidioSubscriptionEpisodeSubcription() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			...
			try {
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionEpisodeSubcription test", e);
			}
			break;
		}
		solo.sendKey(KeyEvent.KEYCODE_BACK);
