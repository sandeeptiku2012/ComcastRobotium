...
public class XidioSubscritptionPopularUnsubscriptionTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	private String userId;
	
	
	public XidioSubscritptionPopularUnsubscriptionTest() {
	...
	public void testXidioSubscritptionPopularUnsubscription() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e("Exception:", "Exception occured in XidioSubscritptionPopularUnsubscription test cases.", e);
		}
