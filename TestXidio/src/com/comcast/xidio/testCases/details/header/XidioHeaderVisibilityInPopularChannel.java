...
public class XidioHeaderVisibilityInPopularChannel extends ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	String elementTitle =null;

	public XidioHeaderVisibilityInPopularChannel() {
	...
	public void testXidioHeaderVisibilityInHomePopularChannel()
	{
