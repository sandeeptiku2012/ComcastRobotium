...
public class XidioSearchHeaderVisibilityChannelEpisode extends ActivityInstrumentationTestCase2<FirstRun> 
{
	private Solo solo;


	public XidioSearchHeaderVisibilityChannelEpisode() {
	...
	public void testSearchHeaderVisibilityInShow() 
	{
		...
		solo.sendKey(KeyEvent.KEYCODE_O);
		ArrayList<JSONObject> filteredChannelAndShows = GetChannelSearchList.getInstance().getChannelSearchList("coo");
		solo.sleep(TestConstants.SLEEP_TIME_500);
		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		solo.sleep(TestConstants.SLEEP_TIME_500);
		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
