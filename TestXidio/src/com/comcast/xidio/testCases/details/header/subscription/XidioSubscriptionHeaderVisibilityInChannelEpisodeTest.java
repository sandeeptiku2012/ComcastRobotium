...
public class XidioSubscriptionHeaderVisibilityInChannelEpisodeTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	private JSONObject currChannel;
	
	public XidioSubscriptionHeaderVisibilityInChannelEpisodeTest() {
	...
	public void testXidioSubscriptionHeaderVisibilityInChannelEpisode() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			...
			try {
				...
				JSONArray subsEpisodesContent = GetEpisodesList.getInstance().getEpisodeList(subsContentKey);
				if(subsEpisodesContent!=null){
					JSONObject showsList = subsEpisodesContent.getJSONObject(0);
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionHeaderVisibilityInChannelEpisode test", e);
			}
		}
		solo.sendKey(KeyEvent.KEYCODE_BACK);
		solo.sleep(TestConstants.SLEEP_TIME_2000);
