...
public class XidioSearchPopularVideoPlayPauseTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;
	private PlayerStatus status;
	private PlayerPlatformAPI platformApi;
	private Boolean adComplete=false;
	public XidioSearchPopularVideoPlayPauseTest() {
	...
	public void testXidioSearchPopularVideoPlayPause() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularVideoPlayPauseTest " , e);
			}
		}
