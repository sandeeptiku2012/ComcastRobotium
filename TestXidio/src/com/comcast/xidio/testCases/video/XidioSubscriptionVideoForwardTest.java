...
public class XidioSubscriptionVideoForwardTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	...
	public XidioSubscriptionVideoForwardTest() {
	...
	public void testXidioSubscriptionVideoForward() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for(int i=0;i<subscribedChannels.length();i++)
		{
			...
			try {
				...
				Log.e("Exception:", "Exception occured in XidioSubscriptionVideoForwardTest test", e);
			}
			break;
		}
		solo.sendKey(KeyEvent.KEYCODE_BACK);
