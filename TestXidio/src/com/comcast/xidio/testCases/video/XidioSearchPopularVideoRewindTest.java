...
public class XidioSearchPopularVideoRewindTest extends	ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;
	...
	public XidioSearchPopularVideoRewindTest() {
	...
	public void testXidioSearchPopularVideoRewind() 
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		for (JSONObject currentObject : channelSearchArray) {
			try {
				...
				Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioSearchPopularVideoRewindTest " , e);
			}
		}
