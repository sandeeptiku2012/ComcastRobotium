...
public class XidioDetailsActivityFeaturedChannelVideoPlay extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;
	...
	public XidioDetailsActivityFeaturedChannelVideoPlay() {
	...
	public void testXidioDetailsActivityFeaturedChannelVideoPlay() 
	{
...
//			platformApi.addEventListener(platformEventListener);
	...
	{
		Log.d("Exception from test XidioDetailsActivityFeaturedChannelVideoPlay = ", e.getLocalizedMessage());
	}
