...
public class XidioHomeActivityFeaturedListShowsTitle extends ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	//String elementTitle =null;

	public XidioHomeActivityFeaturedListShowsTitle() {
	...
	public void testXidioHomeActivityFeaturedListShowsTitle()
	{
...
//						}
		...
		{
			Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioHomeActivityFeaturedListShowsTitle " , e);
			assertTrue(false);
		}
