...
public class XidioHomeFeaturedChaneelWithoutShowDescriptionTest extends
		ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	String elementTitle = null;

	public XidioHomeFeaturedChaneelWithoutShowDescriptionTest() {
	...
	public void testXidioHomeFeaturedChannelWithoutShowDescription() {
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioHomeFeaturedChannelWithoutShowDescription" , e);
			assertTrue(false);
		}
