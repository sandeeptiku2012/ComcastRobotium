...
public class XidioHomeActivityFeaturedListChannelsTitle extends ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	String elementTitle =null;

	public XidioHomeActivityFeaturedListChannelsTitle() {
	...
	public void testXidioHomeActivityFeaturedListChannelsTitle()
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioHomeActivityFeaturedListChannelsTitle " , e);
			assertTrue(false);
		}
