...
import com.comcast.cil.scalerow.ExpandingRow;
...
import com.xfinity.xidio.views.ObjectDetailRow;
import com.xfinity.xidio.views.XidioButton;

public class XidioHomeFeaturedChannelTitleHighlight extends
		ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	String elementTitle = null;

	public XidioHomeFeaturedChannelTitleHighlight() {
	...
	public void testXidioomeFeaturedChannelTitleHighlight() {
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioHomeFeaturedChannelTitleHighlight " , e);
			assertTrue(false);
		}
