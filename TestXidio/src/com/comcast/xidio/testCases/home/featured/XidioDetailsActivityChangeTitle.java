...
public class XidioDetailsActivityChangeTitle extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioDetailsActivityChangeTitle() {
	...
	public void testXidioDetailsActivityChangeTitle()
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
	...
	{
		Log.d("Exception from test XidioDetailsActivityChangeTitle = ", e.getLocalizedMessage());
	}
