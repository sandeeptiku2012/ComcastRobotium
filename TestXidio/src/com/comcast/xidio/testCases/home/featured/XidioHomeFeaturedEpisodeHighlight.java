...
public class XidioHomeFeaturedEpisodeHighlight extends ActivityInstrumentationTestCase2<FirstRun> {

	private Solo solo;
	String elementTitle =null;

	public XidioHomeFeaturedEpisodeHighlight() {
	...
	public void testXidioHomeFeaturedEpisodeHighlight()
	{
...
//		solo.sendKey(KeyEvent.KEYCODE_DPAD_DOWN);
		...
		{
			Log.e(this.getClass().getCanonicalName(), "Failed to complete the test XidioXidioHomeFeaturedEpisodeHighlight " , e);
			assertTrue(false);
		}
