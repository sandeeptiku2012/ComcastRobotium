...
public class XidioHomeActivityChange extends ActivityInstrumentationTestCase2<FirstRun> {
	private Solo solo;

	public XidioHomeActivityChange (){
	...
	public void testXidioHomeActivityChange() 
	{
	...
	{
		Log.d("Exception from test XidioHomeActivityChange : ", e.getLocalizedMessage());
	}
