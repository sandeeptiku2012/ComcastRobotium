...
public class XidioHomePopularEpisodeNetworkImageTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioHomePopularEpisodeNetworkImageTest() {
	...
	public void testXidioHomePopularEpisodeNetworkImage()
	{
		...
		{
			Log.d("Exception from test XidioHomePopularEpisodeNetworkImage = ", e.getLocalizedMessage());
		}
