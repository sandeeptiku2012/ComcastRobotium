...
public class XidioHomePopularShowNetworkImageTest extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioHomePopularShowNetworkImageTest() {
	...
	public void testXidioHomePopularShowNetworkImage()
	{
		...
		{
			Log.d("Exception from test XidioHomePopularShowNetworkImage = ", e.getLocalizedMessage());
		}
