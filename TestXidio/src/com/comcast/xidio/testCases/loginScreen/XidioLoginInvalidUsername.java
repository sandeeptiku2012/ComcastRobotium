...
public class XidioLoginInvalidUsername extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioLoginInvalidUsername() {
	...
	public void testXidioLoginInvalidUsername()
	{
