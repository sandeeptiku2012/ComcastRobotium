...
public class XidioLoginSpecialCharecterInUsername extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioLoginSpecialCharecterInUsername() {
	...
	public void testXidioLoginSpecialCharecterInUsername()
	{
