...
public class XidioLoginEmptyPassword extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioLoginEmptyPassword() {
	...
	public void testXidioLoginEmptyPassword()
	{
