...
public class XidioLoginSpecialCharecterInPassword extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioLoginSpecialCharecterInPassword() {
	...
	public void testXidioLoginSpecialCharecterInPassword()
	{
		...
		solo.sleep(TestConstants.SLEEP_TIME_1000);
			...
			assertFalse(solo.getView(R.id.first_run_error_text).isShown());
			solo.sleep(TestConstants.SLEEP_TIME_1000);
