...
public class XidioLoginEmptyUserNameAndPassword extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XidioLoginEmptyUserNameAndPassword() {
	...
	public void testXidioLoginEmptyUserNameAndPassword()
	{
		...
		solo.sleep(TestConstants.SLEEP_TIME_1000);
			...
			solo.enterText((EditText) solo.getCurrentActivity().findViewById(com.xfinity.xidio.R.id.first_run_password),"");
